...
public class GlobalEventManager : MonoBehaviour
{
    ...
    public static UnityEvent ResetReceivedCoins = new UnityEvent();
    ...
    public static void ChangeSideColor(string HEX) =>
        OnSideColorChange.Invoke(HEX);
    
    public static void ActivateRestarMenu() =>
        RestartMenu.Invoke();
    
    public static void OnResetReceivedCoins() =>
        ResetReceivedCoins.Invoke();
